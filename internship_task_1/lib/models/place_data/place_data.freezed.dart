...
mixin _$PlaceData {
  ...
  List<GuestData> get guestList => throw _privateConstructorUsedError;
  @JsonKey(name: 'wish_list')
  List<WishData> get wishList => throw _privateConstructorUsedError;
...
abstract class $PlaceDataCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'guest_list') List<GuestData> guestList,
      @JsonKey(name: 'wish_list') List<WishData> wishList,
...
class _$_PlaceData implements _PlaceData {
  const _$_PlaceData(
      ...
      @JsonKey(name: 'guest_list') required final List<GuestData> guestList,
      @JsonKey(name: 'wish_list') required final List<WishData> wishList,
      @JsonKey(name: 'product_list')
  ...
  final List<GuestData> _guestList;
  @override
  @JsonKey(name: 'guest_list')
  List<GuestData> get guestList {
    if (_guestList is EqualUnmodifiableListView) return _guestList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_guestList);
  }

  final List<WishData> _wishList;
  @override
  @JsonKey(name: 'wish_list')
  List<WishData> get wishList {
  ...
  @override
  String toString() {
    return 'PlaceData(images: $images, description: $description, date: $date, webLink: $webLink, guestList: $guestList, wishList: $wishList, productList: $productList, entertainmentList: $entertainmentList, location: $location)';
  }
